        ...
        public void Update(GameTime gameTime, KeyboardState keyboard)
        {
            ...
            if (health > 0)
            {
                ...
                if(keyboard.IsKeyDown(Keys.Space) && canShoot == true)
                {
                    ...
                    Projectile fries = new Projectile(ProjectileType.FrenchFries, Game.GetProjectileSprite(ProjectileType.FrenchFries),
                    drawRectangle.X + drawRectangle.Width / 2, drawRectangle.Center.Y + GameConstants.FrenchFriesProjectileOffset, -GameConstants.FrenchFriesProjectileSpeed);
                    Game.AddProjectile(fries);
                    shootSound.Play();
                }
